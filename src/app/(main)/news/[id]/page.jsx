...
const NewsDetailsPage = async ({ params }) => {
    ...
    return (
        <div className="card bg-base-100 shadow-sm mx-auto max-w-4xl px-5 md:px-8 lg:px-12 mb-10">
                    ...
                    <div className='flex justify-end items-center mb-3'>
                        <Link href={`/category/${news.category_id}`}>
                            <button className='btn
                             bg-purple-500 text-base-100 text-base 
                                font-semibold my-2 cursor-pointer' >
                               <BsArrowLeft className='text-xl'/> All news in this category
                            </button>
                        </Link>
                    </div>
